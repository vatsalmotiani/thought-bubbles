...
//   >
//     <div
//       className='relative rounded-3xl p-8 border-4 transform h-96 overflow-hidden'
//       style={{
...
//           />
//           <p style={{ color: "#828282" }}>Interactive Map Goes Here</p>
//         </div>
//       </div>
...
// Mock Form component (will be separate)
// const ContactForm = () => (
//   <motion.div
...
//     >
//       <div
//         className='relative rounded-3xl p-8 border-4 transform'
//         style={{
//           backgroundColor: "white",
//           borderColor: "#00B6E7",
//           boxShadow: "8px 8px 0px #00B6E7",
...
//               className='mx-auto mb-4'
//             />
//             <p>Your Cartoon Form Component Goes Here</p>
//             <p className='text-sm mt-2'>Check the separate form artifact below!</p>
//           </div>
//         </div>
