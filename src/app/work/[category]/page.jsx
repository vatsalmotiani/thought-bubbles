...
export default function WorkCase({ params }) {
  ...
  const cat = unwrappedParams.category;
  ...
  return (
    <div className='flex flex-wrap justify-center xl:w-full mt-4 md:mt-8 px-4 md:px-0'>
            ...
            .map((filteredCase, i) => {
              return (
                <motion.div
                  ...
                  className='w-full sm:w-auto mx-2 sm:mx-4 mb-6 md:mb-2'
                >
