    ...
    <section className='py-20 bg-white'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          <p className='text-xl md:text-2xl text-tb-body max-w-3xl mx-auto font-poppins'>Building bridges since 2009. We've proudly collaborated with esteemed clients, fostering lasting connections and delivering impactful results.</p>
        </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-8 md:gap-12 items-center'
        >
