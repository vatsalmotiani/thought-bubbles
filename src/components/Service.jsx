...
export default function Service({ serviceName = "Branding" }) {
  return (
    <Link href={`/work/${slugify(serviceName)}`}>
      <div className='mx-2 bg-white  w-max rounded-3xl  py-4	px-10 border-b-4 border-sky-200 drop-shadow-sm hover:border-tb-blue hover:drop-shadow-lg duration-300 '>
